...
const steps = [
  {
    ...
    content: "Formez-vous tout en vous informant ! L’actualité brûlante est traitée quotidiennement par notre équipe pédagogique, sous forme de cours vidéo ou d’articles audio. Écoutez au moins une fois le document sans lire le script ou les sous-titres. Réécoutez le document autant de fois que nécessaire pour en saisir toutes les subtilités orales et écrites.",
    image: Caroussel1,
  },
  {
    title: "Aidez-vous de la transcription",
    content: "Sélectionner l'intégralité du script à l'aide de Ctrl + A, ou en maintenant le clic et en faisant glisser la souris sur toute la page. ",
    image: Caroussel2,
  },
  {
    title: "Développez vos compétences",
    content: "Ouvre la fenêtre de ChatGPT dans un navigateur, puis colle le script précédemment copié. Inscris ensuite le prompt suivant : 'Aide-moi à répondre aux questions que je vais te poser à l'aide de ce script.'",
    image: Caroussel3,
  },
  {
    title: "Testez votre compréhension",
    content: "Pour chaque question, suivez les instructions suivantes : - Prenez une capture d’écran de votre réponse -Importez cette capture dans ChatGPT, puis appuyez sur Entrée -Suivez scrupuleusement les indications de l’IA, sans réfléchir par vous-même.",
    image: Caroussel4,
  },
];
